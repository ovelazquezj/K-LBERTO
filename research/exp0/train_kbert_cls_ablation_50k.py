#!/usr/bin/env python3
"""
K-BERT Classification Ablation: 50k triplets
...
class KBERTClassificationAblationMonitor:
    ...
    def __init__(self, kg_triplets=50000, output_dir="./outputs/kbert_cls"):
...
if __name__ == "__main__":
    trainer = KBERTClassificationAblationMonitor(kg_triplets=50000)
    trainer.run_training(kg_path="./brain/kgs/ablation/WikidataES_50000_triplets.spo")
