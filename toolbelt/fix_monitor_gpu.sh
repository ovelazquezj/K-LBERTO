#!/bin/bash
# Agregar GPU usage al monitor

# Backup
cp monitor_progress.sh monitor_progress.sh.backup

# Reemplazar sección de GPU
cat > monitor_progress.sh << 'INNER_EOF'
#!/bin/bash
...
echo "✓ Monitor actualizado con nota sobre GPU"
